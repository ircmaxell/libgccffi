...
class gcc_jit_context { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_context');
    }
...
class gcc_jit_result { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_result');
    }
...
class gcc_jit_object { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_object');
    }
...
class gcc_jit_location { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_location');
    }
...
class gcc_jit_type { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_type');
    }
...
class gcc_jit_field { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_field');
    }
...
class gcc_jit_struct { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_struct');
    }
...
class gcc_jit_function { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_function');
    }
...
class gcc_jit_block { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_block');
    }
...
class gcc_jit_rvalue { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_rvalue');
    }
...
class gcc_jit_lvalue { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_lvalue');
    }
...
class gcc_jit_param { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_param');
    }
...
class gcc_jit_case { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_case');
    }
...
class gcc_jit_timer { 
    ...
    public static function getType(): \FFI\CType {
        return getFFI()->type('gcc_jit_timer');
    }
...
function gcc_jit_context_set_str_option(
    ...
    getFFI()->gcc_jit_context_set_str_option(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $opt, 
        $value);
}
...
function gcc_jit_context_set_bool_allow_unreachable_blocks(
    ...
    getFFI()->gcc_jit_context_set_bool_allow_unreachable_blocks(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $bool_value);
}
...
function gcc_jit_context_set_bool_use_external_driver(
    ...
    getFFI()->gcc_jit_context_set_bool_use_external_driver(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $bool_value);
}
...
function gcc_jit_context_add_command_line_option(
    ...
    getFFI()->gcc_jit_context_add_command_line_option(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $optname);
}
...
function gcc_jit_context_compile(
    ...
    return new gcc_jit_result_ptr(getFFI()->gcc_jit_context_compile(
        is_null($ctxt) ? null : $ctxt->getData()));
}
...
function gcc_jit_context_dump_to_file(
    ...
    getFFI()->gcc_jit_context_dump_to_file(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $path, 
        $update_locations);
}
...
function gcc_jit_context_set_logfile(
    ...
    getFFI()->gcc_jit_context_set_logfile(
        is_null($ctxt) ? null : $ctxt->getData(), 
...
function gcc_jit_context_get_first_error(
    ...
    return new string(getFFI()->gcc_jit_context_get_first_error(
        is_null($ctxt) ? null : $ctxt->getData()));
}
...
function gcc_jit_context_get_last_error(
    ...
    return new string(getFFI()->gcc_jit_context_get_last_error(
        is_null($ctxt) ? null : $ctxt->getData()));
}
...
function gcc_jit_result_get_code(
    ...
    return new void_ptr(getFFI()->gcc_jit_result_get_code(
...
function gcc_jit_result_get_global(
    ...
    return new void_ptr(getFFI()->gcc_jit_result_get_global(
        is_null($result) ? null : $result->getData(), 
        $name));
}
...
function gcc_jit_object_get_context(
    ...
    return new gcc_jit_context_ptr(getFFI()->gcc_jit_object_get_context(
...
function gcc_jit_object_get_debug_string(
    ...
    return new string(getFFI()->gcc_jit_object_get_debug_string(
        is_null($obj) ? null : $obj->getData()));
}
...
function gcc_jit_context_new_location(
    ...
    return new gcc_jit_location_ptr(getFFI()->gcc_jit_context_new_location(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $filename, 
        $line, 
        $column));
...
function gcc_jit_location_as_object(
    ...
    return new gcc_jit_object_ptr(getFFI()->gcc_jit_location_as_object(
...
function gcc_jit_type_as_object(
    ...
    return new gcc_jit_object_ptr(getFFI()->gcc_jit_type_as_object(
...
function gcc_jit_context_get_type(
    ...
    return new gcc_jit_type_ptr(getFFI()->gcc_jit_context_get_type(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $type_));
}
...
function gcc_jit_context_get_int_type(
    ...
    return new gcc_jit_type_ptr(getFFI()->gcc_jit_context_get_int_type(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $num_bytes, 
        $is_signed));
}
...
function gcc_jit_type_get_pointer(
    ...
    return new gcc_jit_type_ptr(getFFI()->gcc_jit_type_get_pointer(
        is_null($type) ? null : $type->getData()));
}
...
function gcc_jit_type_get_const(
    ...
    return new gcc_jit_type_ptr(getFFI()->gcc_jit_type_get_const(
        is_null($type) ? null : $type->getData()));
}
...
function gcc_jit_type_get_volatile(
    ...
    return new gcc_jit_type_ptr(getFFI()->gcc_jit_type_get_volatile(
        is_null($type) ? null : $type->getData()));
}
...
function gcc_jit_context_new_array_type(
    ...
    return new gcc_jit_type_ptr(getFFI()->gcc_jit_context_new_array_type(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
...
function gcc_jit_context_new_field(
    ...
    return new gcc_jit_field_ptr(getFFI()->gcc_jit_context_new_field(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        is_null($type) ? null : $type->getData(), 
        $name));
...
function gcc_jit_field_as_object(
    ...
    return new gcc_jit_object_ptr(getFFI()->gcc_jit_field_as_object(
...
function gcc_jit_context_new_struct_type(
    ...
    return new gcc_jit_struct_ptr(getFFI()->gcc_jit_context_new_struct_type(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        $name, 
        $num_fields, 
...
function gcc_jit_context_new_opaque_struct(
    ...
    return new gcc_jit_struct_ptr(getFFI()->gcc_jit_context_new_opaque_struct(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        $name));
}
...
function gcc_jit_struct_as_type(
    ...
    return new gcc_jit_type_ptr(getFFI()->gcc_jit_struct_as_type(
...
function gcc_jit_struct_set_fields(
    ...
    getFFI()->gcc_jit_struct_set_fields(
        is_null($struct_type) ? null : $struct_type->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        $num_fields, 
        is_null($fields) ? null : $fields->getData());
...
function gcc_jit_context_new_union_type(
    ...
    return new gcc_jit_type_ptr(getFFI()->gcc_jit_context_new_union_type(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        $name, 
        $num_fields, 
...
function gcc_jit_context_new_function_ptr_type(
    ...
    return new gcc_jit_type_ptr(getFFI()->gcc_jit_context_new_function_ptr_type(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
...
function gcc_jit_context_new_param(
    ...
    return new gcc_jit_param_ptr(getFFI()->gcc_jit_context_new_param(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        is_null($type) ? null : $type->getData(), 
        $name));
...
function gcc_jit_param_as_object(
    ...
    return new gcc_jit_object_ptr(getFFI()->gcc_jit_param_as_object(
...
function gcc_jit_param_as_lvalue(
    ...
    return new gcc_jit_lvalue_ptr(getFFI()->gcc_jit_param_as_lvalue(
        is_null($param) ? null : $param->getData()));
}
...
function gcc_jit_param_as_rvalue(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_param_as_rvalue(
        is_null($param) ? null : $param->getData()));
}
...
function gcc_jit_context_new_function(
    ...
    return new gcc_jit_function_ptr(getFFI()->gcc_jit_context_new_function(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        $kind, 
        is_null($return_type) ? null : $return_type->getData(), 
...
function gcc_jit_context_get_builtin_function(
    ...
    return new gcc_jit_function_ptr(getFFI()->gcc_jit_context_get_builtin_function(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $name));
}
...
function gcc_jit_function_as_object(
    ...
    return new gcc_jit_object_ptr(getFFI()->gcc_jit_function_as_object(
...
function gcc_jit_function_get_param(
    ...
    return new gcc_jit_param_ptr(getFFI()->gcc_jit_function_get_param(
        is_null($func) ? null : $func->getData(), 
        $index));
}
...
function gcc_jit_function_dump_to_dot(
    ...
    getFFI()->gcc_jit_function_dump_to_dot(
        is_null($func) ? null : $func->getData(), 
        $path);
}
...
function gcc_jit_function_new_block(
    ...
    return new gcc_jit_block_ptr(getFFI()->gcc_jit_function_new_block(
        is_null($func) ? null : $func->getData(), 
        $name));
}
...
function gcc_jit_block_as_object(
    ...
    return new gcc_jit_object_ptr(getFFI()->gcc_jit_block_as_object(
...
function gcc_jit_block_get_function(
    ...
    return new gcc_jit_function_ptr(getFFI()->gcc_jit_block_get_function(
        is_null($block) ? null : $block->getData()));
}
...
function gcc_jit_context_new_global(
    ...
    return new gcc_jit_lvalue_ptr(getFFI()->gcc_jit_context_new_global(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        $kind, 
        is_null($type) ? null : $type->getData(), 
...
function gcc_jit_lvalue_as_object(
    ...
    return new gcc_jit_object_ptr(getFFI()->gcc_jit_lvalue_as_object(
...
function gcc_jit_lvalue_as_rvalue(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_lvalue_as_rvalue(
        is_null($lvalue) ? null : $lvalue->getData()));
}
...
function gcc_jit_rvalue_as_object(
    ...
    return new gcc_jit_object_ptr(getFFI()->gcc_jit_rvalue_as_object(
...
function gcc_jit_rvalue_get_type(
    ...
    return new gcc_jit_type_ptr(getFFI()->gcc_jit_rvalue_get_type(
        is_null($rvalue) ? null : $rvalue->getData()));
}
...
function gcc_jit_context_new_rvalue_from_int(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_new_rvalue_from_int(
        is_null($ctxt) ? null : $ctxt->getData(), 
...
function gcc_jit_context_new_rvalue_from_long(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_new_rvalue_from_long(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($numeric_type) ? null : $numeric_type->getData(), 
        $value));
}
...
function gcc_jit_context_zero(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_zero(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($numeric_type) ? null : $numeric_type->getData()));
}
...
function gcc_jit_context_one(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_one(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($numeric_type) ? null : $numeric_type->getData()));
}
...
function gcc_jit_context_new_rvalue_from_double(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_new_rvalue_from_double(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($numeric_type) ? null : $numeric_type->getData(), 
        $value));
}
...
function gcc_jit_context_new_rvalue_from_ptr(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_new_rvalue_from_ptr(
        is_null($ctxt) ? null : $ctxt->getData(), 
...
function gcc_jit_context_null(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_null(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($pointer_type) ? null : $pointer_type->getData()));
}
...
function gcc_jit_context_new_string_literal(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_new_string_literal(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $value));
}
...
function gcc_jit_context_new_unary_op(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_new_unary_op(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        $op, 
...
function gcc_jit_context_new_binary_op(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_new_binary_op(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        $op, 
        is_null($result_type) ? null : $result_type->getData(), 
...
function gcc_jit_context_new_comparison(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_new_comparison(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        $op, 
        is_null($a) ? null : $a->getData(), 
...
function gcc_jit_context_new_call(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_new_call(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        is_null($func) ? null : $func->getData(), 
        $numargs, 
...
function gcc_jit_context_new_call_through_ptr(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_new_call_through_ptr(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
...
function gcc_jit_context_new_cast(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_context_new_cast(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        is_null($rvalue) ? null : $rvalue->getData(), 
        is_null($type) ? null : $type->getData()));
...
function gcc_jit_context_new_array_access(
    ...
    return new gcc_jit_lvalue_ptr(getFFI()->gcc_jit_context_new_array_access(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($loc) ? null : $loc->getData(), 
...
function gcc_jit_lvalue_access_field(
    ...
    return new gcc_jit_lvalue_ptr(getFFI()->gcc_jit_lvalue_access_field(
...
function gcc_jit_rvalue_access_field(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_rvalue_access_field(
        is_null($struct_or_union) ? null : $struct_or_union->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        is_null($field) ? null : $field->getData()));
}
...
function gcc_jit_rvalue_dereference_field(
    ...
    return new gcc_jit_lvalue_ptr(getFFI()->gcc_jit_rvalue_dereference_field(
        is_null($ptr) ? null : $ptr->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        is_null($field) ? null : $field->getData()));
}
...
function gcc_jit_rvalue_dereference(
    ...
    return new gcc_jit_lvalue_ptr(getFFI()->gcc_jit_rvalue_dereference(
        is_null($rvalue) ? null : $rvalue->getData(), 
        is_null($loc) ? null : $loc->getData()));
}
...
function gcc_jit_lvalue_get_address(
    ...
    return new gcc_jit_rvalue_ptr(getFFI()->gcc_jit_lvalue_get_address(
        is_null($lvalue) ? null : $lvalue->getData(), 
        is_null($loc) ? null : $loc->getData()));
}
...
function gcc_jit_function_new_local(
    ...
    return new gcc_jit_lvalue_ptr(getFFI()->gcc_jit_function_new_local(
        is_null($func) ? null : $func->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        is_null($type) ? null : $type->getData(), 
        $name));
...
function gcc_jit_block_add_assignment(
    ...
    getFFI()->gcc_jit_block_add_assignment(
        is_null($block) ? null : $block->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        is_null($lvalue) ? null : $lvalue->getData(), 
        is_null($rvalue) ? null : $rvalue->getData());
...
function gcc_jit_block_add_assignment_op(
    ...
    getFFI()->gcc_jit_block_add_assignment_op(
        is_null($block) ? null : $block->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        is_null($lvalue) ? null : $lvalue->getData(), 
        $op, 
...
function gcc_jit_block_add_comment(
    ...
    getFFI()->gcc_jit_block_add_comment(
        is_null($block) ? null : $block->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        $text);
}
...
function gcc_jit_block_end_with_conditional(
    ...
    getFFI()->gcc_jit_block_end_with_conditional(
        is_null($block) ? null : $block->getData(), 
        is_null($loc) ? null : $loc->getData(), 
...
function gcc_jit_block_end_with_jump(
    ...
    getFFI()->gcc_jit_block_end_with_jump(
        is_null($block) ? null : $block->getData(), 
        is_null($loc) ? null : $loc->getData(), 
...
function gcc_jit_block_end_with_return(
    ...
    getFFI()->gcc_jit_block_end_with_return(
        is_null($block) ? null : $block->getData(), 
        is_null($loc) ? null : $loc->getData(), 
        is_null($rvalue) ? null : $rvalue->getData());
}
...
function gcc_jit_context_new_case(
    ...
    return new gcc_jit_case_ptr(getFFI()->gcc_jit_context_new_case(
        is_null($ctxt) ? null : $ctxt->getData(), 
...
function gcc_jit_case_as_object(
    ...
    return new gcc_jit_object_ptr(getFFI()->gcc_jit_case_as_object(
...
function gcc_jit_block_end_with_switch(
    ...
    getFFI()->gcc_jit_block_end_with_switch(
        is_null($block) ? null : $block->getData(), 
        is_null($loc) ? null : $loc->getData(), 
...
function gcc_jit_context_new_child_context(
    ...
    return new gcc_jit_context_ptr(getFFI()->gcc_jit_context_new_child_context(
...
function gcc_jit_context_dump_reproducer_to_file(
    ...
    getFFI()->gcc_jit_context_dump_reproducer_to_file(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $path);
}
...
function gcc_jit_context_enable_dump(
    ...
    getFFI()->gcc_jit_context_enable_dump(
        is_null($ctxt) ? null : $ctxt->getData(), 
        $dumpname, 
...
function gcc_jit_timer_new(
    ...
    return new gcc_jit_timer_ptr(getFFI()->gcc_jit_timer_new());
}

function gcc_jit_timer_release(
    ?gcc_jit_timer_ptr $timer
): void {
    getFFI()->gcc_jit_timer_release(
...
function gcc_jit_context_set_timer(
    ...
    getFFI()->gcc_jit_context_set_timer(
        is_null($ctxt) ? null : $ctxt->getData(), 
        is_null($timer) ? null : $timer->getData());
}
...
function gcc_jit_context_get_timer(
    ...
    return new gcc_jit_timer_ptr(getFFI()->gcc_jit_context_get_timer(
        is_null($ctxt) ? null : $ctxt->getData()));
}
