...
$args2 = gcc_jit_rvalue_ptr_ptr::fromArray(
    gcc_jit_context_new_string_literal($ctxt, "World"),
);

$block2 = gcc_jit_function_new_block($main, "initial");
...
gcc_jit_block_end_with_void_return($block2, NULL);

gcc_jit_context_compile_to_file($ctxt, GCC_JIT_OUTPUT_KIND_EXECUTABLE, __DIR__ . "/test.o");
